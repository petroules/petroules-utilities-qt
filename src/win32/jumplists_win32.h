#if !defined(JUMPLISTS_WIN32_H) && defined(Q_WS_WIN)
#define JUMPLISTS_WIN32_H
...
DEFINE_GUID(IID_IShellLink,0x000214f9,0x0000,0x0000,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,0x46);
